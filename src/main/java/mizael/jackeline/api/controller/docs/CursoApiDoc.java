...
@Tag(
        name = "Cursos",
        description = "Gestão dos cursos de manicure e nail design oferecidos na plataforma"
)
public interface CursoApiDoc {

    @Operation(
            summary = "Listar cursos",
            description = "Retorna todos os cursos cadastrados para exibição no catálogo."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Consulta os detalhes de um curso específico."
    )
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Curso não encontrado", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
    })
    ...
    @Operation(
            summary = "Criar curso",
            description = "Cria um novo curso com título, descrição, valor e status de publicação."
    )
    @ApiResponses(value = {
    ...
    @Operation(
            ...
            description = "Remove um curso do catálogo da plataforma."
    )
    @ApiResponses(value = {
